...
CONFIG_PATH = r"c:\Land Record\training\configs\kothi_targeted.yaml"
OUTPUT_DIR = r"c:\Land Record\models\trocr\kothi_targeted_checkpoints"
os.makedirs(OUTPUT_DIR, exist_ok=True)

print("=" * 80, flush=True)
print("  TARGETED KANNADA FINE-TUNING EXPERIMENT (ತಿ vs ಲಿ vs ಟಿ vs ಡಿ vs ರಿ)", flush=True)
print("=" * 80, flush=True)
...
print("\n[3] Starting Targeted Fine-Tuning...", flush=True)
...
if not os.path.exists(best_ckpt_dir):
    # Save the current model state into best_checkpoint
