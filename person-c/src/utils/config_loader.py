...
class ConfigLoader:
    ...
    def detect_state_from_text(self, text: str) -> str:
        ...
        if any(w in text_lower for w in ["ಕರ್ನಾಟಕ", "karnataka", "ಭೂಮಿ", "bhoomi", "ಪಹಣಿ", "pahani", "ಸರ್ವೆ ನಂ", "ಖಾತೆದಾರ", "ಬೆಂಗಳೂರು", "bangalore", "bengaluru", "bbmp", "mahanagara palike", "khatha", "ಪ್ರಮಾಣ ಪತ್ರ"]):
            return "KA"
